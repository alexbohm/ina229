...
fn read_current_raw_works() {
    ...
    let spi_expectations = [
        ...
        SPITransaction::write_vec(vec![0x1D]),
        SPITransaction::read_vec(vec![0x4C, 0xCC, 0xC0]),
...
fn read_power_raw_works() {
    ...
    let spi_expectations = [
        SPITransaction::transaction_start(),
        SPITransaction::write_vec(vec![0x21]),
        SPITransaction::read_vec(vec![0x48, 0x00, 0x0C]),
        SPITransaction::transaction_end(),
    ];
    let spi = SPIMock::new(&spi_expectations);
    let mut ina229 = INA229::new(spi);
